...
$jobject =  json_encode($resultArray);
pg_free_result($result);
    pg_close($conn_string);
    socket_write($msgsock, $jobject, strlen($jobject)) or die("socket_write() failed: reason: " . socket_strerror(socket_last_error()) ."/n");  
